...
class NotificationService {
  ...
  static const String _eventChannelDescription = 'Notifications for new events';
    ...
    try {
      FirebaseFirestore.instance
        ...
        if (snapshot.docs.isNotEmpty) {
          ...
          // Check if the event was recently added (within the last minute)
          final now = DateTime.now();
          final eventCreationTime = latestEvent.startTime;
          if (now.difference(eventCreationTime).inMinutes < 1) {
            // Add to recently processed set to prevent duplicates
